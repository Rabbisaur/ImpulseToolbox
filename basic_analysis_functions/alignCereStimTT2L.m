function alignCereStimTTL2(basepath,blockNumber,TTLchannel,instanceRange,TrialAlignTimeStamp,trialParam)
debug = 0;
...
for thisTTLchannel = 1:NumTTLchannel
    ...
    eval(cmd);
    electrodeRawTrialData = VnCGetTrialData2(instanceinfo, EID,trialAlignST,trialParam);

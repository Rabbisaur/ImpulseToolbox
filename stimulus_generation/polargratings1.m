function pattern = polargratings(sizeX,sizeY,meanLum,contrast,concentricspatialfreq,radialspatialfreq,phase,supersampling,bgLum,maskflag,maskRadius,maskstd)
...
L = @(x,y)cos(2*pi*concentricspatialfreq*sqrt(x^2+y^2)+radialspatialfreq*atan2(y,x)+phase);

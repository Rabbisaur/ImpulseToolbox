function instanceinfo = VnCgetNeuraldata3(instanceinfo,trialAlignSTfieldname,MUAparameters,LFPparameters, SpikenWaveParameters,trialParam,savefilename,loadSpikenMUAsFlag)
matversion = '-v6';
if ispc
    slash = '\';
else

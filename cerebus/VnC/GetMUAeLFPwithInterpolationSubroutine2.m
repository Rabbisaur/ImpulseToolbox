 function [MUAe, LFP] = GetMUAeLFPwithInterpolationSubroutine2(RawData,RawDataSampleRate,MUAparameters,interpolationTimepoints,interpolationLength,LFPparameters)
...
if LFPsupersamplingRatio > 1
    ...
    LFPdata = interp1(x,LFPdata,xx,'spline');
...
%     x = 1:datalength;
%     xx = 1:(1/MUAesupersamplingRatio):datalength;
%     FRdata = interp1(x,FRdata,xx,'spline');
% %     MUAeData = spline(x, MUAeData', xx)';
% end

function instanceinfo = VnCArtifactRemoval4(instanceinfo,StimulationParam,CurrentLevel,MUAparameters,LFPparameters,trialParam,trialAlignSTfieldname,interpolationLength,DebugFlag)
...
%             DebugFlag = 1;
            [CondTrialData, artifactTimepoints] = VnCRemoveArtifactsSubroutine3(CondTrialData,StimulationParam,CondStimStartEndTime,SampleRate,SupersamplingRatio,DebugFlag);

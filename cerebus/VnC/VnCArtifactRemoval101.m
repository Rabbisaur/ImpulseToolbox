function instanceinfo = VnCArtifactRemoval10(instanceinfo,StimulationParam,MUAparameters,LFPparameters,trialParam,trialAlignSTfieldname,interpolationLength,DebugFlag)
disp('Removing stimulation artifacts...')

matversion = '-v6';
interpolationLengthDP = 4;
...
for thisInstance = 1:numInstances
    ...
    for thisElec = 1:numElec
        ...
        [trialData, AllArtifactTimepoints,Interpolateddata,WaveDPbefore,WaveDPafter] = VnCRemoveArtifactsSubroutine8(trialData,StimulationParam,StimStartTime,SampleRate);

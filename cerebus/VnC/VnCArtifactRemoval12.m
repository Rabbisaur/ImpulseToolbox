function instanceinfo = VnCArtifactRemoval12(instanceinfo,StimulationParam,MUAparameters,LFPparameters,trialParam,trialAlignSTfieldname,interpolationLength,GoodTrialIdx,GoodMStrialIdx,ARFineAlignFlag)
...
for thisInstance = 1:numInstances
    ...
    for thisElec = 1:min([numElec,128])
        ...
        [trialData, AllArtifactTimepoints,Interpolateddata,WaveDPbefore,WaveDPafter] = VnCRemoveArtifactsSubroutine10(trialData,StimulationParam,StimStartTime,SampleRate,EID,thisInstance,instanceinfo,GoodMStrialIdx,ARFineAlignFlag);
